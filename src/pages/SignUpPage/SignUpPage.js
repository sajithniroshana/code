            ...
            <div className={"flex justify-center items-center"}>
              ...
              <div className={"form_section "}>
                <div className={"flex justify-center items-center"}>
                  ...
                  <div className={"form_section "}>
                    <div className=" flex justify-center items-center mt-5">
                      <p className="font-bold sm:text-l  md:text-xl lg:text-2xl xl:text-4xl mb-12">
                        {" "}
                        Sign Up to GoviSewana{" "}
                      </p>
                    </div>
              ...
              <div className={"form_section "}>
                <div className={"flex justify-center items-center"}>
                  ...
                  <div className={"form_section "}>
                    ...
                    <div className="relative ">
                      <label className="block mb-2 text-gray-700 text-end px-14 w-6/12">
                        Full Name
                      </label>
                      <div className="flex justify-center items-center">
                        <input
                    ...
                    <div className="relative ">
                      <label className="block mb-2 text-gray-700 text-end px-7 w-4/12">
                        NIC
                      </label>
                      <div className="flex justify-center items-center">
                        <input
