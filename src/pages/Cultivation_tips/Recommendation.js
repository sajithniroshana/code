      ...
      <div className="hidden sm:flex ">
        <div className="container1">
          ...
          <div className="Recommendation-content">
            ...
            <div className="Recommendation-content-2 bg-green-500 m-5 rounded-lg">
              <div className="">
                <div className=" ">
                  <p className="text-md text-3xl font-bold p-2 pt-3 text-green-800">
                    {" "}
                    Tips For Sesonal Crops{" "}
                  </p>
                </div>
              </div>
              <div className="Recommendation-content-2-content">
                <div className="Recommendation-content-2-content-1 bg-white pt-5 ">
                  ...
                  <div className="description">
                    <p className="text-black text-center">
                      Explore tips, disease <br /> management,
                      <br /> harvesting times and <br /> more
                    </p>
                  </div>
                ...
                <div className="Recommendation-content-2-content-2 bg-white pt-5">
                  <div className="box-image">
                    <img src={Carrot} alt="" />
                  </div>
                  <div className="name">
                ...
                <div className="Recommendation-content-2-content-3 bg-white pt-5">
                  <div className="box-image">
                    <img src={Beetroot} alt="" />
                  </div>
                  <div className="name">
                    <h3 className="text-xl font-bold">Beetroot</h3>
                    <div className="name-line"></div>
                  </div>
                  <div className="description">
                    <p className="text-black text-center">
